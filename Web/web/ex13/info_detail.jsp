<%-- 
    ...
    Created on : 2017/02/03, 20:45:32
    Author     : g031n047
--%>
...
<html>
    ...
    <body>
        ...
        <section class="wrap2">
            <h2 class="title_pos">登録内容</h2>
            <article>
                データ件数：<%= info.getNum()%>
                <table class="mdl-data-table mdl-js-data-table">
                    <thead class="column_pos">
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr class="column_pos"><td><a href="/Web/ex13/information.jsp?code=<%= info.getCamId(i)%>"><%= info.getCamId(i)%></a></td>
                            <td><a href="http://stocks.finance.yahoo.co.jp/stocks/detail/?code=<%= info.getCamId(i)%>"><%= info.getCamName(i)%></a></td>                     
                            <td><%= info.getDate(i)%></td></tr>
                            <% }%>
                    </tbody>
                </table>
            </article>
